...
from engine.models import QueryStat, Snapshot
from engine.rules.base import Finding, Rule, register
...
class SlowMeanTimeQuery(Rule):
    id = "R-Q2"
    title = "Query is slow on every execution"
    category = "queries"
        ...
        for q in snapshot.queries:
            ...
            findings.append(
                self.finding(
                    ...
                    suggested_action=(
                        "Every execution takes over a second. Check the execution plan for "
